...
|-----------|-----------|---------|
| [smolagents](smolagents.md) | Minimal, code-first | Quick prototypes, research |
| [LlamaIndex](llamaindex.md) | Data-centric, workflows | RAG-heavy applications |
| [LangGraph](langgraph.md) | Graph-based control flow | Complex, stateful pipelines |
...
_Add your unit 2 overview notes here._
